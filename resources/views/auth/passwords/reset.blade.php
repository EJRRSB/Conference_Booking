                                    ...
                                    <form class="user"  method="POST" action="{{ route('password.update') }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control form-control-user  @error('email') is-invalid @enderror" name="email"
                                                id="email" aria-describedby="emailHelp" value="{{ $email ?? old('email') }}" autocomplete="email" autofocus
                                                 required>  
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="password" class="form-control form-control-user  @error('password') is-invalid @enderror" name="password_confirmation" autocomplete="new-password"
